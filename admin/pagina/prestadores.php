        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Todos os Prestadores</h3>
                </div>
                            ...
                            <?php foreach($query->fetchAll() as $customer){ ?>
                                <tr class="ui-sortable">
                                    ...
                                    <td style="min-width:65px;">
                                        <a href="view_prestador.php?id=<?php echo $customer['id']; ?>">
                                            <i class="fa fa-eye"></i></a>
                                        <a href="edit_prestador.php?id=<?php echo $customer['id']; ?>">
                                            <i class="fa fa-edit"></i></a>
                                        <a href="delete_prestador.php?id=<?php echo $customer['id']; ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>
