    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                ...
                <span class="info-box-number">Sua conta não é de prestador de serviços...</span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <section class="content">
        <!-- Small boxes (Stat box) -->
            <div class="row">
                ...
                <a href="?page=perfil&user=<?php echo $contas['login']; ?>"><div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                            <span class="info-box-icon bg-aqua"><i class="fa fa-user"></i></span>


                            <div class="info-box-content">
                                <span class="info-box-text">Meu Perfil</span>
                                <small class="info-box-number"> <?php //$servicos = $db->query("SELECT IFNULL(SUM(valor) as SOMA FROM servicos WHERE id_prestador = ". $contas['id'])->fetchAll(); echo $servicos['SOMA']; ?> </small>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                ...
                <!-- /.col -->
                <a href="?page=chamados"> <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                            <span class="info-box-icon bg-red"><i class="fa fa-location-arrow"></i></span>

                            <div class="info-box-content">
                                <span> <b>Chamados Atendidos</b></span><bR>
                                <small><?php echo $db->query("SELECT * FROM chamados WHERE id_prestador =".$contas['id'])->rowCount(); ?></small>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                ...
                <a href="?page=chamados"><div class="col-md-3 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text">Chamados Ativos Atualmente</span>
                                <span class="info-box-number"><?php echo $db->query("SELECT * FROM chamados WHERE id_prestador IS NULL AND ativo='1'")->rowCount(); ?></span>
                            </div>
                            <!-- /.info-box-content -->
                        </div>
                        <!-- /.info-box -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        ...
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number"><?php echo $db->query("SELECT id FROM contas WHERE online = '1' AND tipo_conta = '1';")->rowCount(); ?></span>
                        </div>
                        <!-- /.info-box-content -->
                    </div>
                    <!-- /.info-box -->
                        ...
                        <div class="box box-widget">
                            <div class="box-header with-border">
                                <div class="user-block">
                                    ...
                                    <span class="description"><?php if($postagem['tipo']==1){echo "Postagem Pública";} ?> - <?php echo date("d/M. Y h:i", strtotime($postagem['data'])); ?></span>
                                </div>
                                <!-- /.user-block -->
                                <div class="box-tools">
                            ...
                            <div class="panel-footer">
                                ...
                                if($cont_c == 0){echo '<div class="box-footer box-comments"><center>Nenhum comentário...</center></div>';} else {
                                    ...
                                    <div class="box-comment">
                                        <div class="media" style="margin-top:-10px;">
                                            <div class="media-left media-top">
                                                <img class="img-circle img-sm" src="<?php echo $user_comentario['foto']; ?>" alt="User Image"></div>
